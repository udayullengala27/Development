    ...
    <>
         <Card>
                ...
                <Col xl='3' md='6' className='stats d-flex flex-column justify-content-center align-items-center gap-1 '>
                    <p className=' fw-bolder mb-0'>Total Reach</p>
                    <h1 className='statsCount'>3,52,522</h1>
                ...
                <Col xl='3' md='6' className='stats d-flex flex-column align-items-center gap-1'>
                    <p className=' fw-bolder mb-0'>Clicks</p>
                    <h1 className='statsCount'>1,703</h1>
                ...
                <Col xl='3' md='6' className='stats d-flex flex-column align-items-center gap-1'>
                    <p className=' fw-bolder mb-0'>Redemptions</p>
                    <h1 className='statsCount'>135</h1>
                ...
                <Col xl='3' md='6' className='stats d-flex flex-column align-items-center gap-1'>
                    <p className=' fw-bolder mb-0'>Revenue</p>
                    <h1 className='statsCount'>0</h1>
