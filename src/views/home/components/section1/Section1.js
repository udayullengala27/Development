    ...
    <div className='d-flex justify-content-center align-items-center' style={{ height: "100vh" }}>
      ...
      <div className=' d-flex justify-content-center align-items-center gap-5'>
        ...
        <div className=' p-2' style={{ width: "40%" }}>
          <h5 className=' fw-bolder mb-1'>THE STATEMENT</h5>
          <h1 className=' mb-1' style={{ width: "300px", fontWeight: "900", lineHeight: "1.5" }}>We're On A Mission To Help Businesses Grow</h1>
          <h3 className=' mb-1' style={{ color: "#F6CB45" }}>Reduce Bounce Rates</h3>
          <p className=' mb-1' style={{ width: "300px", lineHeight: "1.5" }}>H3 with line spacing - Lorem ipsum dolor sit H3 with line spacing - Lorem ipsum dolor sit</p>
