    ...
    return (
        <div className=' position-relative' style={{ padding: "230px 0" }}>
            ...
            <div className=' py-3' style={{ background: "#F6CB4554.33%", paddingLeft: "100px" }}>
                <p className=' fw-bold'>THE TESTIMONY</p>
                <h2 className=' fw-bolder mb-2' style={{ width: "550px" }}>XIRCLS  matching process takes into account so many variables that I wouldn't even have thought of when trying to hire a marketing agency.</h2>
                ...
                <p><span className="fw-bolder ">Name of user,</span> title of user</p>
            </div>
        </div>
    )
}
