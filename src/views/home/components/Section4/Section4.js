    ...
    return (
        <div style={{ padding: "80px 100px" }}>
            <div style={{ paddingBottom: "100px" }}>
                <h4 className=' text-center fw-bold mb-2'>THE SOLUTION</h4>
                <h1 className=' text-center fw-bolder' style={{ lineHeight: "1.5" }}>How does it work? well, it’s as <br />easy as enroll, engage, reward.</h1>
                <div className=' d-flex justify-content-between align-items-center gap-5 my-5'>
                    <div>
                        <img src={expand} alt="expand" className=' mb-1' />
                        <h4 className=' fw-bolder'>Lorem ipsum dolor sit </h4>
